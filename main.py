...
def ukrainian_transform(text: str) -> str:
    ...
    UKRAINIAN_WORD_REPLACEMENTS = {
        ...
        "армия": "орки", "путин": "хуiло", "зеленский": "зеля", 
        "украина": "ненька", "донбасс": "донбас", "крым": "крим", 
        "военный": "окупант", "спецоперация": "агресiя", "фронт": "фронт",
        "тыл": "тил", "боец": "нацик", "герой": "героi", "орден": "ордiн",
        "медаль": "медаль", "сво": "агресiя", "нато": "нато", "запад": "захiд",
