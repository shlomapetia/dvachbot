...
def ukrainian_transform(text: str) -> str:
    ...
    UKRAINIAN_WORD_REPLACEMENTS = {
        # Основные слова
        "спасибо": "дякую", "пожалуйста": "будь ласка", "привет": "привiт",
        "пока": "бувай", "хорошо": "норм", "плохо": "ковiдно", "человек": "людина",
        "мужчина": "чоловик", "женщина": "жiнка", "ребенок": "дитина", "деньги": "гривнi",
        "работа": "робота", "дом": "хата", "город": "мiсто", "страна": "країна",
        ...
        "баба":"жiнка", "парень":"хлопець", "мужик":"козакь", "мужчина":"козакь", "девушка":"жiнка", "кот":"кiт", "гарфилд":"РУСНЯВIЙ ПОРОСЬ", 
        "двач":"кропiвачь", "моча":"гетьман", "мод":"гетьман", "админ":"Батько наш Бiндера", "немного":"трошкi", "чуть":"трошкi", 
        "тцк":"вбiвають москалiв", "хохол":"госпiдарь москалiв", "хохлы":"Свiрхлюдiни", "адмен":"Батько наш Бiндера", 
        ...
        "есть": "їсти", "пить": "пити", "спать": "спати", "идти": "йти", 
        ...
        "украина": "ненька", "донбасс": "донбас", "крым": "крiм", 
        ...
        "говно": "говно", "дерьмо": "дерьмо", "северный": "пiвнiчний", "блядь": "курва",
        "сука": "чорт", "шлюха": "шльондра", "пиздабол": "брехун", "еблан": "єблан",
...
_PROFESSIONS = ["сантехник", "грузчик", "охранник", "менеджер по продажам", "стоматолог", 
