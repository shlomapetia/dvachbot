...
HELP_TEXT_COMMANDS = [
    (
        "<b>Команды, которые ты можешь использовать в этом хаосе:</b>\n\n"
        "/start - начать\n"
        "/help - помощь\n"
        "/stats - статистика\n"
        "/face - случайное ебало\n"
        "/roll - ролл 0-100\n"
        "/invite - пригласить анонов\n"
        "/deanon - деанон постера\n"
        "/active - активность досок\n"
        "/hent /fap /gatari - аниме пикча\n"
        "/anime - режим 🌸 Аниме\n"
    ...
    (
        ...
        "/face - Сгенерировать случайное лицо.\n"
        ...
        "/hent /fap /gatari - Отправить аниме-арт.\n"
...
HELP_TEXT_EN_COMMANDS = [
    ...
    (
        ...
        "/face - To generate a random face.\n"
