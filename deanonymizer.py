...
DEANON_NAMES = [
    "Валера", "Геннадий", "Дмитрий", "Аркадий", "Николай", "Женя", "Чмоня", "Арестарх", "Иннокентий", "Акакий",
    ...
    "Андрей", "Иван", "Данил", "Саня", "Лёша", "Коля", "Ваня", "Петя", "Саша", "Миша", "Спермотоксикозник",
    "Матвей", "Руслан", "Артем", "Илья", "Денис", "Егор", "Максим", "Кирилл", "Доброжир", "Степан",
    "Тимур", "Артём", "Даниил", "Ахмет", "Бахтияр", "Ашот", "Боря", "Славик", "Славка", "Антоша", "Маня", "Анонимус", "Вениамин", "Тимурка", "Джамшут", "Всеволод", "Прохор"
]
DEANON_SURNAMES = [
    "Андреев", "Борисов", "Васильев", "Григорьев", "Дмитриев", "Егоров", "Туалетов", "Скуфьин", "Жирнов",
    "Захаров", "Иванов", "Константинов", "Леонидов", "Михайлов", "Николаев", "Подзалупный", "Пердунов",
    "Пукин", "Орлов", "Петров", "Романов", "Смирнов", "Титов", "Ульянов", "Федоров", "Залупкин",
    ...
    "Хуйкин", "Чехов", "Шевцов", "Щербаков", "Юрьев", "Яковлев", "Яшин", "Пиздюков", "Спермоусов",
    "Пидарасов", "Пидоров", "Пидоровский", "Ленковец", "Нагибалов", "Навальный", "Жидомасонов", "Пригожин",
    ...
    "Минетов", "Спермов", "Членов", "Вагин", "Сосунков", "Педиков", "Гомиков", "Аналов", "Джугашвили"
]
DEANON_CITIES = [
    "Магнитогорск", "Челябинск", "Тюмень", "Уфа", "Омск", "Кемерово", "Мухосранск", "Зажопинск",
    "Братск", "Норильск", "Воркута", "Ухта", "Сызрань", "Саранск", "Тольятти", "Нижний Тагил", "Череповец",
    "Липецк", "Тольятти", "Набережные Челны", "Магадан", "Петропавловск-Камчатский", "Усть-Пиздюйск",
    "Новокузнецк", "Красноярск", "Иркутск", "Кемерово", "Новосибирск", "Красноярск", "Рыбинск",
    "Ижевск", "Сургут", "Сыктывкар", "Вологда", "Владивосток", "Москва", "Самара", "Биробиджан",
    "Саратов", "Казань", "Пенза", "Киев", "Минск", "Днiпро", "Грозный", "Хабаровск", "Чапаевск",
    "Нефтекамск", "Ижевск", "Москва", "Москва", "Санкт-Петербург", "Санкт-Петербург", "Верхняя Пышма",
    "Навашино", "Село Пердяевка", "Ангарск", "Астана", "Уральск", "Каменск-Шахтинский", "Харькiв", "Киев", "Днiпро", "Бобруйск"
]
DEANON_STREETS = [
    "Ленина", "Советская", "Мира", "Центральная", "Молодежная", "Школьная", "Садовая", "Лесная", "Новая", "Набережная",
    "Зеленая", "Парковая", "Солнечная", "Речная", "Спортивная", "Юбилейная", "Гагарина", "Пушкина", "Кирова", "Строителей",
    "Заводская", "Колхозная", "Рабочая", "Береговая", "Полевая", "Северная", "Южная", "Восточная", "Западная", "Садовая",
    "Вишневая", "Яблоневая", "Липовая", "Кленовая", "Октябрьская", "Первомайская", "Космонавтов", "Горького", "Чкалова", "Фрунзе",
    "Чапаева", "Суворова", "Кутузова", "Железнодорожная", "Вокзальная", "Станционная", "Профсоюзная", "Клубная", "Пионерская", "Комсомольская",
    "Хуесосов", "Адольфа Гитлера", "Туалетная", "Пидорская", "Просроченных Гондонов", "Дедов-инсайдов", "им. Двача",
    "Пьяных Трактористов", "Пупкина", "Унитазная", "Говнярка", "Гомосексуалистов", "Анальных Исследований",
    "Пукинская", "Заднеприводных", "Высиранов СВО", "Анусная", "проспект Анальных Трещин", "бульвар Разведённых Шлюх",
    "Долбоёбов", "Говноедов", "Пидорасов", "Гейская", "Обосранная", "проезд Скуфов", "тупик Инцелов",
    "Бомжацкая", "Шлюхина", "Гондонов", "им. Холокоста", "Двачевская", "Наримана Намазова"
]
DEANON_PROFESSIONS = [
    "сантехник", "грузчик", "охранник", "менеджер по продажам", "стоматолог", "психически больной", "ворует пенсию бабушки", "ворует металл", "тестировщик резиновых хуёв",
    "электрик", "безработный", "дворник", "алкаш", "наркодилер", "в колл центре работает", "подметает дворы", "высиран сво", "является инвалидом", "каппер-скамер",
    "вор в законе", "охотник на педофилов", "разнорабочий", "хиккан", "РНН ГОСПОДИН", "свошник", "штурмовик Z", "Бо Синн", "свошник", "стример-инцел", "администратор /b/",
    "грузчик", "разработчик ПО", "уборщик сортиров", "вор в пятерочке", "торговец героином", "разработчик", "штаб навального", "сборщик пасскодов на Дваче", "тестировщик диванов",
    "смотритель помойки", "сборщик бутылок", "попрошайка", "сутенер", "зоофил", "проститутка", "админ бота", "модератор", "модератор двача", "закладчик",
    ...
    "гей шлюха", "трансгендер", "аниматор", "диджей", "бармен", "бармен-пидор", "бариста", "анимешник", "художник", "писатель фанфиков", "обзорщик шаурмы"
]
DEANON_FETISHES = [
    "ножки школьниц", "трусики бабушек", "Школьницы", "Еврейское порно", "Егор Летов", "испражнения в банке", "волосатые подмышки пенсионерок", "запах подвала",
    "трупы голубей", "просроченный майонез", "порно 80-х", "анимешные девочки", "классический секс", "держание за руки", "обнимашки", "когда на тебя кричит кассирша",
    "запах говна", "гнойные прыщи", "фекалии", "Янка Дягилева и сибпанк", "немецкие видео с изнасилованиями", "пыльные ковры",
    ...
    "зоофилия", "негры", "девочки", "мамки", "детское порно", "боллбастинг", "пожилые", "смешные картинки", "влажные салфетки", "запах краски",
    "анальный секс", "классический секс", "мигранты", "азиаты", "евреи", "афроамериканцы", "нюдсы Абу", "наблюдать за спящими",
    "латиноамериканцы", "индийцы", "китайцы", "японцы", "корейцы", "школьницы на коленках", "моногатари", "надувные игрушки",
    "хентай", "фурри", "негры", "девочки", "мамки", "детское порно", "боллбастинг", "шотакон", "лоликон", "Сенгоку Надеко",
    "пожилые", "анальный секс", "классический", "уринация", "бдсм", "свинг", "соло", "самоотсос", "обмазывание говном",
    "групп секс", "оргизм", "минет", "фелацио", "кунилингус", "анальный секс", "оргазм", "звук открывающейся банки пива"
]
DEANON_DETAILS = [
    "скрывает криминальное прошлое", "сосет у работодателя", "мочится в раковину", "плачет во время секса", "думает, что он главный герой",
    "ебется с детьми", "боится темноты", "коллекционирует дилдаки", "унизили на дебатах в универе", "продал кота за скин в CS:GO",
    "имеет 5 судимостей", "просрочил паспорт", "не моется 2 недели", "отфрендзонен шлюхой", "боится голубей", "считает Гоблина интеллектуалом",
    ...
    "инвалид по дурке", "член 10 см", "добрый, приятный человек", "стыдится своего лица", "стыдится своего голоса",
    "мечтает изнасиловать школьницу", "ему понравились моногатари", "любит анальную мастурбацию",
    "латентный пидор", "его отец был чуркой", "он просто забитый чмошник", "уверен, что его мнение важно",
    ...
    "недавно вновь обоссался под себя во сне", "не бреется из принципа",
...
# --- ENGLISH LISTS (EXPANDED) ---
DEANON_NAMES_EN = [
    "John", "Michael", "David", "Chris", "Mike", "James", "Robert", "William", "Richard", "Eugene", "Walter", "Chad", "Kyle", "Brandon", "Kevin", "Scott", "Peter", "Anonymous", "Abu", "Tyrone", "Jamal", "Bob", "Rick", "Morty", "Homer", "Bartholomew", "Arthur", "Cletus", "Eugene", "Mortimer"
]
DEANON_SURNAMES_EN = [
    "Smith", "Johnson", "Williams", "Brown", "Jones", "Miller", "Davis", "Wilson", "Anderson", "Taylor", "Moore", "Jackson", "White", "Harris", "Martin", "Thompson", "Garcia", "Martinez", "Robinson", "Clark", "Rodriguez", "Lewis", "Lee", "Walker", "Hall", "Allen", "Young", "King", "Wright", "Hill", "Scott", "Green", "Adams", "Baker", "Faggot", "Cuckson", "Biden", "Trump", "Freeman", "Doe", "Cockburn", "Dickinson"
]
DEANON_CITIES_EN = [
    "New York", "Los Angeles", "Chicago", "Houston", "Phoenix", "Philadelphia", "San Antonio", "San Diego", "Dallas", "San Jose", "Austin", "Jacksonville", "London", "Birmingham", "Manchester", "Glasgow", "Liverpool", "Bristol", "Sheffield", "Detroit", "Ohio", "Mumbai", "Beijing", "Berlin", "Gary, Indiana", "Compton", "Silent Hill", "Raccoon City", "Cheeseburger Walrus", "Nowhere"
]
DEANON_STREETS_EN = [
    "Main St", "Elm St", "High St", "Washington St", "Park Ave", "Oak Ave", "Maple St", "2nd St", "3rd St", "Church St", "Broad St", "Center St", "Fake St", "Faggot Alley", "Cuckold Drive", "Retard Rd", "Loser Lane", "Gaylord Ave", "4chan Blvd", "Anon Way", "Groomer Grove", "Incel Intersection"
]
DEANON_PROFESSIONS_EN = [
    "plumber", "loader", "security guard", "sales manager", "dentist", "mentally ill", "steals grandma's pension", "steals metal", "rubber dildo tester", "electrician", "unemployed", "janitor", "alcoholic", "drug dealer", "call center operator", "fast-food worker", "war veteran", "disabled person", "thief", "pedophile hunter", "handyman", "hikikomori", "NEET", "software developer", "toilet cleaner", "shoplifter at Walmart", "heroin dealer", "Discord mod", "dumpster diver", "bottle collector", "beggar", "pimp", "zoophile", "prostitute", "bot admin", "moderator", "4chan mod", "personal hole of Abu", "CP operator", "vape seller", "gay prostitute", "transgender", "animator", "DJ", "bartender", "faggot-bartender", "barista", "weeb", "artist", "YouTuber", "professional Redditor", "crypto scammer"
]
DEANON_FETISHES_EN = [
    "schoolgirls' feet", "grandmas' panties", "schoolgirls", "scat", "dead pigeons", "expired mayonnaise", "80s porn", "anime girls", "hand-holding", "hugging", "smell of shit", "pustules", "feces", "used tampons", "autofellatio", "college girls", "rape", "sex with sheep", "dried cum", "fisting", "interracial", "interspecies", "zoophilia", "black guys", "girls", "moms", "child porn", "ballbusting", "elderly", "funny pictures", "anal sex", "migrants", "asians", "jews", "african-americans", "Abu's nudes", "hentai", "furry", "shotacon", "lolicon", "watersports", "BDSM", "cuckoldry", "pegging", "being called a 'good boy'", "financial domination"
]DEANON_DETAILS_EN = [
