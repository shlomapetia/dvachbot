...
# --- Интернет и общение (Internet & Communication) ---
    ...
    "время": ["時間", "タイム"], "времени": ["時間", "タイム"],
    "час": ["時間", "アワー"], "часа": ["時間", "アワー"],
    "минута": ["分", "ミニット"], "минуты": ["分", "ミニット"],
    "секунда": ["秒", "セカンド"], "секунды": ["秒", "セカンド"],
    "неделя": ["週", "ウィーク"], "недели": ["週", "ウィーク"],
    "месяц": ["月", "マンス"], "месяца": ["月", "マンス"],
    "год": ["年", "イヤー"], "года": ["年", "イヤー"],
    "век": ["世紀", "センチュリー"], "века": ["世紀", "センチュリー"],
    ...
    "любовь": ["愛", "ラブ"], "любви": ["愛", "ラブ"],
    "ненависть": ["憎しみ", "ヘイト"], "ненависти": ["憎しみ", "ヘイト"],
    ...
    "в": ["で", "に", "の中に"], "во": ["で", "に"], "на": ["で", "に", "の上に"], "под": "の下に", "над": "の上に", "за": ["の後ろに", "のために"], "перед": "の前に", "с": ["と", "で"], "из": "から", "из-под": "の下から", "из-за": ["の後ろから", "のために"], "у": ["のところに", "で"], "к": ["に", "へ"], "по": ["で", "に沿って"],
    ...
    "благодаря": "のおかげで", "согласно": "によると", "вопреки": "にもかかわらず", "несмотря на": "にもかかわらず", "и": "と", "а": ["だが", "一方で"], "но": ["しかし", "でも"], "да": "そして", "или": "か", "чтобы": ["ために", "ように"], "если": "もし", "потому что": "なぜなら", "так как": "なので", "хотя": ["だけど", "にもかかわらず"], "как": ["ように", "として"], "что": ["こと", "というもの"],
    "когда": "時に", "где": "所で", "куда": ["所へ", "方向に"], "откуда": "から", "почему": "なぜ", "зачем": "なぜ", "ли": "かどうか", "то": "それ", "же": "も",
    ...
    "тысяча": "千", "миллион": "百万", "миллиард": "十億", "триллион": "一兆", "сколько": "いくつ", "столько": "それだけ",
...
# --- Глаголы и действия (Verbs & Actions) ---
    ...
    "говорить": "言う", "говорю": "言う", "говорит": "言う", "говорят": "言う", "сказать": "言う", "сказал": "言った", "сказала": "言った", "сказало": "言った", "сказали": "言った", "скажу": "言うだろう", "говорил": "言った", "говорила": "言った", "говорило": "言った", "говорили": "言った", "говорю": "言うだろう",
    "делать": "する", "делаю": "する", "делает": "する", "делают": "する", "сделать": "する", "сделал": "した", "сделала": "した", "сделало": "した", "сделали": "した", "делать": "する", "делал": "した", "делала": "した", "делало": "した", "делали": "した",
    "смотреть": "見る", "смотрю": "見る", "смотрит": "見る", "смотрят": "見る", "посмотрел": "見た", "посмотрела": "見た", "посмотрело": "見た", "посмотрели": "見た", "смотрел": "見た", "смотрела": "見た", "смотрело": "見た", "смотрели": "見た",
    "видеть": "見える", "вижу": "見える", "видит": "見える", "видят": "見える", "увидел": "見えた", "увидела": "見えた", "увидело": "見えた", "увидели": "見えた", "видел": "見えた", "видела": "見えた", "видело": "見えた", "видели": "見えた",
    "идти": "行く", "иду": "行く", "идет": "行く", "идут": "行く", "пошел": "行った", "пошла": "行った", "пошло": "行った", "пошли": "行った", "шел": "行った", "шёл": "行った", "шла": "行った", "шло": "行った", "шли": "行った",
    "знать": "知る", "знаю": ["知ってる", "分かってる"], "знает": "知ってる", "знают": "知ってる", "узнал": "知った", "узнала": "知った", "узнало": "知った", "узнали": "知った",
    "думать": "思う", "думаю": "思う", "думает": "思う", "думают": "思う", "подумал": "思った", "подумала": "思った", "подумало": "思った", "подумали": "思った", "думал": "思った", "думала": "思った", "думало": "思った", "думали": "思った",
    ...
    "ждать": "待つ", "жду": "待ってる", "ждет": "待ってる", "ждут": "待ってる", "подождал": "待った", "подождала": "待った", "подождали": "待った", "ждал": "待った", "ждала": "待った", "ждали": "待った",
    "писать": "書く", "пишу": "書く", "пишет": "書く", "пишут": "書く", "написал": "書いた", "написала": "書いた", "написали": "書いた", "писал": "書いた", "писала": "書いた", "писали": "書いた",
    "читать": "読む", "читаю": "読む", "читает": "読む", "читают": "読む", "прочитал": "読んだ", "прочитала": "読んだ", "прочитали": "読んだ", "читал": "読んだ", "читала": "読んだ", "читали": "読んだ",
    "смеяться": "笑う", "смеюсь": "笑う", "смеется": "笑う", "смеются": "笑う", "засмеялся": "笑った", "засмеялась": "笑った", "смеялись": "笑った", "смеялся": "笑った", "смеялась": "笑った", "смеялись": "笑った",
    "плакать": "泣く", "плачу": "泣く", "плачет": "泣く", "плачут": "泣く", "заплакал": "泣いた", "заплакала": "泣いた", "заплакали": "泣いた", "плакал": "泣いた", "плакала": "泣いた", "плакали": "泣いた",
    "играть": "遊ぶ", "играю": "遊ぶ", "играет": "遊ぶ", "играют": "遊ぶ", "поиграл": "遊んだ", "поиграла": "遊んだ", "поиграли": "遊んだ", "сосешь": ["しゃぶってる", "フェラしてる"], "сосет": ["しゃぶってる", "フェラしてる"], "сосем": ["しゃぶってる", "フェラしてる"], "сосете": ["しゃぶってる", "フェラしてる"],
    "работать": "働く", "работаю": "働く", "работает": "働く", "работают": "働く", "работал": "働いた", "работала": "働いた", "работали": "働いた",  "играл": "遊んだ", "играла": "遊んだ", "играли": "遊んだ",  "играло": "遊んだ",
    ...
    "ебу": "ファックする", "ебет": "ファックする", "ебал": "クソだ", "ебёт": "ファックする", "кончить": ["イく", "射精する", "抜く", "逝く"], "кончу": ["イく", "イきます", "射精する", "抜く"],
    "кончил": ["イった", "射精した", "抜いた", "逝った"], "кончила": ["イった", "射精した", "抜いた", "逝った"], "кончили": ["イった", "射精した", "抜いた", "逝った"], "кончит": ["イく", "射精する", "抜く", "逝く"], "кончаю": ["イってる", "射精している", "抜いている"],
    "трахать": ["ヤる", "ファックする", "犯す"], "трахаю": ["ヤってる", "ファックしてる"], "трахаешь": ["ヤってる", "ファックしてる"], "трахает": ["ヤってる", "ファックしてる"], "трахаем": ["ヤってる", "ファックしてる"], "трахаете": ["ヤってる", "ファックしてる"], "трахают": ["ヤってる", "ファックしてる"], "трахал": ["ヤった", "ファックした"], "трахала": ["ヤった", "ファックした"], "трахали": ["ヤった", "ファックした"], "трахай": ["ヤれ", "ファックしろ"], "трахайте": ["ヤれ", "ファックしろ"],
    "сосать": ["しゃぶる", "フェラする", "チュパチュパする"], "сосу": ["しゃぶってる", "フェラしてる"], "сосёшь": ["しゃぶってる", "フェラしてる"], "сосёт": ["しゃぶってる", "フェラしてる"], "сосём": ["しゃぶってる", "フェラしてる"], "сосёте": ["しゃぶってる", "フェラしてる"], "сосут": ["しゃぶってる", "フェラしてる"], "сосал": ["しゃぶった", "フェラした"], "сосала": ["しゃぶった", "フェラした"], "сосали": ["しゃぶった", "フェラした"], "соси": ["しゃぶれ", "フェラしろ"], "сосите": ["しゃぶれ", "フェラしろ"],
    "дрочить": ["シコる", "オナる", "マスターベーションする"], "дрочу": ["シコってる", "オナってる"], "дрочишь": ["シコってる", "オナってる"], "дрочит": ["シコってる", "オナってる"], "дрочим": ["シコってる", "オナってる"], "дрочите": ["シコってる", "オナってる"], "дрочат": ["シコってる", "オナってる"], "дрочил": ["シコった", "オナった"], "дрочила": ["シコった", "オナった"], "дрочили": ["シコった", "オナった"], "дрочи": ["シコれ", "オナれ"], "дрочите": ["シコれ", "オナれ"],
